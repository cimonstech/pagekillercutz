...
export async function POST(request: Request) {
  try {
    ...
    const sms = `Hi ${o.customer_name}, order ${o.order_number} has been delivered. Enjoy! — Page KillerCutz`;
    ...
    logger.errorRaw("route", "[api/notify/order-delivered]", err);
